  ...
  const features: Feature[] = [
    {
      ...
      description:
        "CBSE affiliated curriculum with modern teaching methods and personalized attention.",
    ...
    },
    {
      ...
      description:
        "Dedicated faculty with years of expertise in their respective fields.",
    ...
    },
    {
      ...
      description:
        "Smart classrooms, science labs, computer lab, and well-stocked library.",
    ...
    },
    {
      ...
      description:
        "Sports, arts, music, debate, and robotics club for holistic development.",
