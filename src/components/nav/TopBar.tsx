...
import { FaEnvelope, FaMapMarkerAlt, FaPhoneAlt, FaFacebook, FaTiktok } from 'react-icons/fa';
  ...
  >
    <div className="max-w-7xl mx-auto px-6 py-3 flex flex-wrap items-center justify-between gap-4">
      ...
      <a href="#home" className="flex items-center gap-3 hover:opacity-90 transition">
        ...
        />
        <div>
          <h1 className="font-bold text-primary text-xl leading-tight">Cornerstone Foundation</h1>
          <p className="text-secondary font-semibold text-base">Education for Excellence</p>
        </div>
      </a>
      ...
      <div className="hidden lg:flex items-center gap-8">
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-base font-semibold text-gray-800">Damak-06, Jhapa</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-base font-semibold text-[#1a3a5c]">cornerstonedmk@gmail.com</p>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <p className="text-base font-semibold text-gray-800">+977-23585188</p>
      ...
      <div className="hidden md:flex items-center gap-2">
        <a href="https://facebook.com/csfdamak" target="_blank" rel="noopener noreferrer"
          className="w-10 h-10 rounded-full bg-blue-600 text-white flex items-center justify-center hover:bg-blue-700 transition">
          <FaFacebook size={16} />
        </a>
        <a href="https://tiktok.com/@cornerstone_foundation" target="_blank" rel="noopener noreferrer"
