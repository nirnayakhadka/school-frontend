  ...
  const startCycle = (idx: number) => {
    ...
    slideRef.current = setTimeout(() => {
      ...
      setTimeout(() => {
        setCurrent(next);
        startCycle(next);
      }, 300); // brief zoom-out before switching
    }, DURATION);
  };
