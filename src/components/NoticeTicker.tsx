...
const notices: Notice[] = [
  ...
  { id: 2, day: "01", month: "Apr", title: "सूचना ।", link: "#" },
  {
    ...
    day: "17",
    month: "Mar",
    title: "परीक्षाको तयारी बिदा सम्बन्धी सूचना",
    link: "#",
  },
  {
    id: 4,
    day: "17",
    month: "Feb",
    title: "नतिजा प्रकासन सम्बन्धि सूचना ।",
    link: "#",
  },
  { id: 5, day: "17", month: "Feb", title: "सूचना ।", link: "#" },
  {
    ...
    day: "17",
    month: "Feb",
    title: "कक्षा सञ्चालन सम्बन्धि सूचना ।",
    link: "#",
  },
  {
    id: 7,
    ...
    month: "Feb",
    title:
      "कक्षा ११ र १२ तर्फको नतिजा प्रकाशन तथा रक्तदान कार्यक्रम सम्बन्धी सूचना",
    link: "#",
  },
  {
    id: 8,
  ...
  { id: 9, day: "26", month: "Feb", title: "सूचना (विद्यालय तर्फ)", link: "#" },
  {
    ...
    day: "30",
    month: "Mar",
    title: "कक्षा १२ को वार्षिक परीक्षाको प्रवेश पत्र सम्बन्धी सूचना",
    link: "#",
  },
  {
    id: 11,
    day: "07",
    month: "Apr",
    title: "कक्षा ११ वार्षिक परीक्षा (Board Exam) को समय तालिका",
    link: "#",
  },
];
...
const NoticeTicker = () => {
  ...
  return (
    <div className="w-full bg-secondary text-white py-1.5 overflow-hidden">
      <div className="flex items-center">
        {/* Label */}
        <div
          className="flex-shrink-0 bg-[#2442b2] text-white px-5 py-1.5 font-semibold text-sm flex items-center gap-2 relative z-10"
          style={{
            ...
            {duplicated.map((notice, idx) => (
              ...
              >
                <div className="flex-shrink-0 w-8 h-8 rounded-full bg-white flex flex-col items-center justify-center shadow">
                  <span className="text-[10px] font-bold text-[#2442b2] leading-tight">
                    {notice.day}
                  </span>
                  <span className="text-[8px] text-[#2442b2] leading-tight">
                    {notice.month}
                  </span>
                </div>
